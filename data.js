...
let CUM_CONG_NGHIEP = [
    ...
    {
        id: 18, ten: "Cụm công nghiệp Đông Phố Mới", huyen: "tp-lao-cai", xa: "Phường Lào Cai",
    ...
    {
        id: 19, ten: "Cụm công nghiệp Sơn Mãn", huyen: "tp-lao-cai", xa: "Phường Lào Cai",
...
let CCN_CHUA_DAU_TU = [
    { stt: 1, ten: "Cụm công nghiệp Phú Thịnh 4", huyen: "yen-binh", xa: "Xã Yên Bình", dienTich: 75, huongPhatTrien: "" },
    { stt: 2, ten: "Cụm công nghiệp Tân Lĩnh", huyen: "luc-yen", xa: "Xã Tân Lĩnh", dienTich: 75, huongPhatTrien: "" },
    { stt: 3, ten: "Cụm công nghiệp Thượng Bằng La", huyen: "van-chan", xa: "Xã Thượng Bằng La", dienTich: 20, huongPhatTrien: "Sau 2030 mở rộng lên thành 50 ha" },
    { stt: 4, ten: "Cụm công nghiệp Bảo Thắng (Phố Lu)", huyen: "bao-thang", xa: "Xã Bảo Thắng", dienTich: 40, huongPhatTrien: "Sau 2030 mở rộng lên thành 75ha" },
    { stt: 5, ten: "Cụm công nghiệp Bản Phung", huyen: "van-ban", xa: "Xã Văn Bàn", dienTich: 40, huongPhatTrien: "" },
    { stt: 6, ten: "Cụm công nghiệp Trà Trẩu", huyen: "bao-thang", xa: "Xã Bảo Thắng", dienTich: 35, huongPhatTrien: "Sau 2030 mở rộng lên thành 50ha" },
    { stt: 7, ten: "Cụm công nghiệp Xuân Ái", huyen: "van-yen", xa: "Xã Xuân Ái", dienTich: 35, huongPhatTrien: "Tăng 40 ha" },
    { stt: 8, ten: "Cụm công nghiệp Tân Hợp", huyen: "van-yen", xa: "Xã Tân Hợp", dienTich: 40, huongPhatTrien: "Tăng 35 ha" },
    { stt: 9, ten: "Cụm công nghiệp Bát Xát", huyen: "bat-xat", xa: "Xã Bát Xát", dienTich: 53, huongPhatTrien: "Tăng 04 ha" },
    { stt: 10, ten: "Cụm công nghiệp Mường Khương", huyen: "muong-khuong", xa: "Xã Mường Khương", dienTich: 10, huongPhatTrien: "Tăng 20 ha" },
    { stt: 11, ten: "Cụm công nghiệp Tân An", huyen: "bao-yen", xa: "Xã Bảo Hà", dienTich: 16.5, huongPhatTrien: "Tăng 23,5 ha" },
    { stt: 12, ten: "Cụm công nghiệp Hòa Mạc", huyen: "van-ban", xa: "Xã Văn Bàn", dienTich: 7, huongPhatTrien: "Tăng 13 ha" },
    { stt: 13, ten: "Cụm công nghiệp Bản Phiệt 1", huyen: "tp-lao-cai", xa: "Phường Lào Cai", dienTich: 75, huongPhatTrien: "" },
    { stt: 14, ten: "Cụm công nghiệp Cam Đường 1", huyen: "tp-lao-cai", xa: "Phường Cam Đường", dienTich: 40, huongPhatTrien: "" },
    { stt: 15, ten: "Cụm công nghiệp Cam Đường 2", huyen: "tp-lao-cai", xa: "Phường Cam Đường", dienTich: 12, huongPhatTrien: "" },
    { stt: 16, ten: "Cụm công nghiệp Phố Ràng 1", huyen: "bao-yen", xa: "Xã Bảo Yên", dienTich: 56, huongPhatTrien: "" },
    { stt: 17, ten: "Cụm công nghiệp Phố Ràng 2", huyen: "bao-yen", xa: "Xã Bảo Yên", dienTich: 75, huongPhatTrien: "" },
    { stt: 18, ten: "Cụm công nghiệp Quang Kim 1", huyen: "bat-xat", xa: "Xã Bát Xát", dienTich: 55, huongPhatTrien: "" },
    { stt: 19, ten: "Cụm công nghiệp Mông Sơn", huyen: "yen-binh", xa: "Xã Bảo Ái", dienTich: 50, huongPhatTrien: "" },
    { stt: 20, ten: "Cụm công nghiệp Tân Nguyên", huyen: "yen-binh", xa: "Xã Bảo Ái", dienTich: 55, huongPhatTrien: "" },
    { stt: 21, ten: "Cụm công nghiệp An Bình", huyen: "van-yen", xa: "Xã Đông Cuông", dienTich: 50, huongPhatTrien: "" },
    { stt: 22, ten: "Cụm công nghiệp Ngòi A", huyen: "van-yen", xa: "Xã Mậu A", dienTich: 62, huongPhatTrien: "" },
    { stt: 23, ten: "Cụm công nghiệp Yên Hưng", huyen: "van-yen", xa: "Xã Mậu A", dienTich: 42, huongPhatTrien: "" },
    { stt: 24, ten: "Cụm công nghiệp Bản Phiệt 2", huyen: "tp-lao-cai", xa: "Phường Lào Cai", dienTich: 75, huongPhatTrien: "" },
    { stt: 25, ten: "Cụm công nghiệp Yên Hợp 1", huyen: "van-yen", xa: "Xã Xuân Ái", dienTich: 63, huongPhatTrien: "" },
    { stt: 26, ten: "Cụm công nghiệp Yên Hợp 2", huyen: "van-yen", xa: "Xã Xuân Ái", dienTich: 75, huongPhatTrien: "" },
    { stt: 27, ten: "Cụm công nghiệp Văn Chấn", huyen: "van-chan", xa: "Xã Văn Chấn", dienTich: 75, huongPhatTrien: "" },
    ...
    { stt: 32, ten: "Cụm công nghiệp Gia Hội", huyen: "van-chan", xa: "Thôn Nậm Pươi, xã Gia Hội, tỉnh Lào Cai", dienTich: 50, huongPhatTrien: "Đề xuất bổ sung quy hoạch — đang nghiên cứu, chưa có trong QĐ 525/QĐ-UBND (UBND xã đề xuất tháng 6/2026).", deXuatBoSung: true },
    { stt: 33, ten: "Cụm công nghiệp Phong Hải", huyen: "bao-thang", xa: "Thôn Nậm Chủ, xã Phong Hải, tỉnh Lào Cai", dienTich: 75, huongPhatTrien: "Đề xuất bổ sung quy hoạch — đang nghiên cứu, chưa có trong QĐ 525/QĐ-UBND (UBND xã đề xuất tháng 6/2026).", deXuatBoSung: true }
];
