...
set TU=%~1
for %%F in (bot-data360x.py cai-dat.bat chay-bot.bat chay-thu.bat dang-nhap-lan-dau.bat dat-lich.bat bo-lich.bat cap-nhat-ngay.bat quet-lai-120-ngay.bat quet-lai-ngay.bat xuat-phien.bat cai-runner.bat) do (
    if /I not "%%F"=="%TU%" (
