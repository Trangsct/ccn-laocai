...
def build_stats(data):
    ...
    o.append(f"- Cụm công nghiệp đã thành lập: {len(tl)} cụm, tổng diện tích 970,46 ha (đất công nghiệp 650,32 ha, đã cho thuê 188,75 ha; tỷ lệ lấp đầy bình quân trên 30% theo đất công nghiệp đã cho thuê); 234 dự án/cơ sở sản xuất thứ cấp (199 đang hoạt động, 18 đang triển khai đầu tư, 17 dừng hoạt động); tổng ngân sách nhà nước đã đầu tư hạ tầng 332,01 tỷ đồng. Phân nhóm quản lý: 16 cụm do UBND cấp xã, phường quản lý (hạ tầng từ ngân sách, chưa đồng bộ) và 07 cụm do doanh nghiệp làm chủ đầu tư hạ tầng (Minh Quân, Phú Thịnh 1, Phú Thịnh 2, Phú Thịnh 3, Y Can, Thống Nhất 1, Bảo Minh — đang giải phóng mặt bằng). Theo dữ liệu danh mục, {tt.get('hoat-dong',0)} cụm trạng thái đang hoạt động, {tt.get('xay-dung',0)} cụm đang xây dựng.\n")
    ...
    o.append(f"- Khu công nghiệp: {len(kcn)} đơn vị trong danh mục — 12 đã thành lập/đã chấp thuận chủ trương đầu tư, 9 chưa thành lập (theo Quy hoạch). Trong đó 05 KCN mới được chấp thuận chủ trương đầu tư đồng thời chấp thuận nhà đầu tư tháng 6-7/2026: Bản Qua (QĐ 2170/QĐ-UBND ngày 23/6/2026, quy mô dự án 76,39 ha, KCN sinh thái, NĐT Công ty CP Đầu tư phát triển công nghiệp Lào Cai - Shinec), Phú Xuân (QĐ 2336/QĐ-UBND ngày 02/7/2026, 300 ha, NĐT Công ty CP Công nghiệp Linh Linh), Phú Xuân 1 (QĐ 2338/QĐ-UBND ngày 02/7/2026, 200 ha, cùng NĐT Linh Linh), Võ Lao (QĐ 2463/QĐ-UBND ngày 16/7/2026, 482,6 ha, NĐT Công ty CP đầu tư hạ tầng Châu Giang), Cam Đường (QĐ 2548/QĐ-UBND ngày 23/7/2026, 196,3 ha, KCN sinh thái, NĐT Công ty CP đầu tư Lê Premium). Trạng thái: {kcn_tt.get('hoat-dong',0)} hoạt động, {kcn_tt.get('xay-dung',0)} đang xây dựng, {kcn_tt.get('quy-hoach',0)} quy hoạch, {kcn_tt.get('rut-qh',0)} rút khỏi quy hoạch.\n")
